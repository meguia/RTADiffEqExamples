...
using  PortAudio.LibPortAudio, PlutoUI, DifferentialEquations
...
# ╔═╡ 2ed04915-4427-49c5-a493-838c16d39924
begin
	# Global Parameters
...
source = rt_ODESource(saxRN!, u0, [0.3, 0.6], sample_rate ; channel_map = [1,2])
...
g $(@bind g Slider(0.0:0.01:0.2,default=0.1;show_value=true)) \
...
manifest_format = "2.0"
project_hash = "fc9c703363689f9d70a69e0c60dc56a58dfb8114"
