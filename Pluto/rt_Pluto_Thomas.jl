...
# ╔═╡ d565af2a-84f9-4209-9e5d-e432928809f3
theme(:dark)
...
begin
	ticks
	sol = solve(ODEProblem(thomas!,source.data.state.u,(source.data.state.t,source.data.state.t+tail),source.data.control.p));
	plot(sol,idxs=(1,2),c=:yellow,label="",border=:none,size=(800,600))
end	
...
begin 
	...
	@atomic source.data.control.p = [a, b]
