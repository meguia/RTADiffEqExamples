...
using RealTimeAudioDiffEq, PlutoUI, DifferentialEquations, Plots, JLD2
...
# ╔═╡ b7518c55-68d0-45f4-b247-5962a6321fa4
begin
	s1 = load("ns12.jld2")
...
kc : $(@bind kc Slider(0.01:0.01:2.0,default=1.8;show_value=true)) $sp
c : $(@bind c Slider(0.0:0.01:1.0,default=0.3;show_value=true)) \
...
begin
	theme(:default) 
	p1 = contourf(μ2list,μ1list,(λs[:,:,2]'.>-1e-3)*1+(λs[:,:,1]'.>1e-3)*2,lw=0,levels=2,c=[:white,:blue,:red],colorbar=false)
	scatter!(p1,[μ2],[μ1],c=:black,label="")
	plot!(p1,ns1[1],ns1[2],c=:blue,label="")
	plot!(p1,ns2[1],ns2[2],c=:blue,label="")
	plot!(p1,[0,0],[-0.4,0.4],c=:black,label="")
	plot!(p1,[-0.4,0.4],[0,0],c=:black,label="",size=(600,400),xlims=(-0.4,0.3),ylims=(-0.1,0.4))
end;
...
begin
	theme(:dark)
	p2 = plot(sol,idxs=(1,2),c=:yellow,label="")
	plot!(p2,sol,idxs=(3,4),c=:green,label="",border=:none)
end;	

# ╔═╡ e85de8c5-7641-4035-9ae2-0b627fab6ca9
PlutoUI.ExperimentalLayout.Div([p1,p2], style=Dict(	"display" => "flex","flex-direction" => "row","background" => "gray"))
...
manifest_format = "2.0"
project_hash = "632741cee632295ff9490ad2ca2b98d7823a5bd2"
...
git-tree-sha1 = "e467b0a065fb3252fff8c7068aa8d57df3cd6796"
...
git-tree-sha1 = "3298b7bf7942f4f1dd806e5812c07cb7c1503838"
